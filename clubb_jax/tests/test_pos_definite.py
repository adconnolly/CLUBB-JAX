...
# _ROOT must come first so `import clubb_jax` resolves to the real package, NOT clubb_release/clubb_jax/
# (which has no `src` and would shadow it). The clubb_release paths (for clubb_python + clubb_f2py) are appended.
