...
# (iter 392: dropped the derived_types/grid_class one/zero/one_half entries — those re-exported constants had no
...
_ALLOW = {
    ...
    # iter 606: constants_clubb.py re-exports the model_flags.F90 enum parameters from their Fortran home
    # (model_flags.py) so `from constants_clubb import iiPDF_ADG1/order_*/ipdf_*` keeps working; these are
    # deliberate re-exports (imported-then-re-exported), not dead.
    ("constants_clubb.py", "ipdf_pre_advance_fields"),
    ("constants_clubb.py", "ipdf_post_advance_fields"),
    ("constants_clubb.py", "ipdf_pre_post_advance_fields"),
    ("constants_clubb.py", "iiPDF_ADG1"),
    ("constants_clubb.py", "l_gamma_Skw"),
    ("constants_clubb.py", "l_advance_xp3"),
    ("constants_clubb.py", "order_xm_wpxp"),
    ("constants_clubb.py", "order_xp2_xpyp"),
    ("constants_clubb.py", "order_wp2_wp3"),
    ("constants_clubb.py", "order_windm"),
}
