...
# Append (not prepend) the f2py dir so clubb_release/clubb_jax/ can't shadow the real clubb_jax package.
_F2PY = os.path.join(_ROOT, "clubb_release", "clubb_python_api")
