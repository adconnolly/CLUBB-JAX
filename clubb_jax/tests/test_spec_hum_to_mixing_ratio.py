...
def test_conversions():
    ...
    jf = np.asarray(flux_spec_hum_to_mixing_ratio(rtm, wpqtp))
    jg = np.asarray(force_spec_hum_to_mixing_ratio(rtm, qtm_forcing))
    ...
    identity = np.asarray(flux_spec_hum_to_mixing_ratio(np.zeros_like(wpqtp), wpqtp))
